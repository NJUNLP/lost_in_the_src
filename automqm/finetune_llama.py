...
class TrainingArguments(transformers.TrainingArguments):
    ...
    use_lora: bool = field(default=False, metadata={"help": "Whether to user LoRA"})
    lora_config: Optional[str] = field(default=None, metadata={"help": "LoRA config file path"})
...
def make_supervised_data_module(tokenizer: transformers.PreTrainedTokenizer, data_args) -> Dict:
    ...
    if data_args.valid_data_path is not None:
        eval_dataset = SupervisedDataset(tokenizer=tokenizer, data_path=data_args.valid_data_path)
...
def train():
    ...
    if training_args.use_lora:
        ...
        lora_config = LoraConfig(
            ...
            target_modules=l_config["lora_target_modules"],
